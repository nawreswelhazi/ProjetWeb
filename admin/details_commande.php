...
if (isset($_POST['click_view_btn'])) {
    ...
    <li><strong>Nom:'.$commande['nom'].'</strong></li>
    <li><strong>prenom:'.$commande['prenom'].'</strong> </li>
    <li><strong>E-mail:'.$commande['email'].'</strong> </li>
    <li><strong>date de commande:'.$commande['date'].'</strong> 
    </li><hr></ul>
    <table class="table detailscommande" >
